    ...
    <Box py={16} px={8} bg="gray.50">
      <Stack spacing={4} textAlign="center" mb={10}>
        ...
        <Text fontSize="lg" color="gray.600">
          TrashHub is a comprehensive platform for managing waste from source to
          end-of-lifecycle and recycling.
        </Text>
      </Stack>
      ...
      >
        <Box rounded="lg" width={"70%"} display={"flex"} gap={5}>
          <About
            color="white"
            heading="Trash Tag"
            description=" Users can scan QR codes on products and merchant bins to earn rewards for proper disposal.
          ...
          <About
            color="white"
            heading=" BinOcculars"
            description="  A user-friendly interface to find specific-purpose dustbins for waste like electronics, metal, etc.
